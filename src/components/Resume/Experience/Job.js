  ...
  <article className="jobs-container space-y-10 page-body-text">
    <div>
      ...
      <ul className="ml-5 list-disc space-y-2 pl-1 text-left text-base leading-relaxed marker:text-primary/35">
        ...
        <li><span>Authored and led content production for over&nbsp;</span><strong><span>400+ long-form articles</span></strong><span>&nbsp;and glossary pages,&nbsp;</span><strong><span>300+ infographics</span></strong><span>, and an AI-focused <a className="cursor-pointer text-primary underline-offset-2 hover:underline" href="https://chisellabs.com/pdfs/chisel-ai-e-book.pdf" target="_blank" rel="noopener noreferrer"><strong>eBook</strong></a> titled &ldquo;</span><strong><span>AI and the Future of Product Management</span></strong><span>&rdquo;, which attracted&nbsp;</span><strong><span>1,000s of reads and drove 80+ product signups</span></strong><span>.</span></li>
