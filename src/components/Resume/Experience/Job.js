  ...
  <article className="jobs-container">
    <div>
      ...
      <ul style={{textAlign: 'left', fontSize: '16px'}}>
        ...
        <li><span>Led and executed partnership-driven content marketing strategies with organizations like Product School, Product Collective, The Product Folks, QuestionPro, and Trimeta, resulting in&nbsp;</span><strong><span>50,000+ YouTube views</span></strong><span>&nbsp;and significantly expanded brand reach.</span></li>
    ...
    <div>
      ...
      <ul style={{textAlign: 'left', fontSize: '16px'}}>
        ...
        <li><span>Developed and delivered&nbsp;</span><strong><span>100+ content assets</span></strong><span>, including blogs, whitepapers, landing pages, and eBooks, contributing to a&nbsp;</span><strong><span>35% uplift in lead conversions</span></strong><span>&nbsp;for client campaigns.</span></li>
